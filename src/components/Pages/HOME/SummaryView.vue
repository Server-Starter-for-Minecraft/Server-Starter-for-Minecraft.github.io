...
<template>
  <div>
    <ssSubTitle>
      ServerStarterでマルチプレイを始めましょう !!
    </ssSubTitle>
    <p>
      ServerStarterは Windows / MacOS / Linux で使用できます.
    </p>
    <p>
      導入はとても簡単！<br>
        <SsA url="/intro">ServerStarter2のはじめかた</SsA>を見れば誰でも利用することができます.<br />
        あなたのマルチプレイ生活を今から始めましょう!
    </p>
