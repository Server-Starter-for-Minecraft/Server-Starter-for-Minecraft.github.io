  ...
  <q-card flat style="max-width: 100%">
    <q-card-section>
      ...
      <q-stepper v-model="step_intro" flat animated>
        <q-step :name="1" title="1. 導入" :done="step_intro > 1">
          ...
          <div class="q-py-md q-gutter-md">
            <q-expansion-item
              label="ダウンロード時に警告が出た場合"
              header-class="bg-orange-4"
            >
              <q-card flat class="bg-orange-2">
                <q-card-section>
                  ...
                  <p>
                    ...
                    <a
                      href="https://github.com/Server-Starter-for-Minecraft/ServerStarter2"
                      target="_blank"
                      class="a"
                      >GitHub</a
                    >
                  ...
                  <div class="row q-gutter-md items-center">
                    <q-img
                      src="~assets/Introduction/Edge_Save1.png"
                      style="min-width: 15rem"
                      class="col fit"
                    />
                    <q-img
                      src="~assets/Introduction/Edge_Save2.png"
                      style="min-width: 15rem"
                      class="col"
                    />
                  </div>
                    ...
                    <q-tab-panels v-model="tab_index" animated>
                      <q-tab-panel name="win">
                        <ol>
                          ...
                          <ss-img
                            path="assets/Introduction/defender1.png"
                          ...
                          <ss-img
                            path="assets/Introduction/defender2.png"
                            style="max-width: 15rem"
                          />
                        </ol>
                      </q-tab-panel>
                      ...
                      <q-tab-panel name="mac">
                        <ol>
                          ...
                          <ss-img
                            path="assets/Introduction/unopen.png"
                            style="max-width: 15rem"
                          />
                          <li>
                          ...
                          <ss-img
                            path="assets/Introduction/privacy.png"
                            style="max-width: 15rem"
                          />
                        </ol>
                      </q-tab-panel>

                      <q-tab-panel name="linux"> </q-tab-panel>
                    </q-tab-panels>
                  </q-card>
                </q-card-section>
              </q-card>
        ...
        >
          ...
          <q-img
            src="~assets/Introduction/WelcomeWindow.png"
            width="min(500px,100%)"
          />
          <q-stepper-navigation>
        ...
        <q-step
          :name="4"
          title="3-2. 初期設定（プレイヤー登録）"
          :done="step_intro > 3"
        >
          <p>
            Minecraftのプレイヤーアカウントを持っている場合は、ゲーム内でのプレイヤー名を登録しましょう！
          </p>
          <p>
          ...
          <div class="row q-gutter-md items-center">
            <q-img
              src="~assets/Introduction/OwnerPlayerSetting1.png"
              style="min-width: 15rem"
              class="col fit"
            />
            <q-img
              src="~assets/Introduction/OwnerPlayerSetting2.png"
              style="min-width: 15rem"
              class="col"
            />
          </div>
      ...
      <q-stepper v-model="step_run" flat animated>
        <q-step :name="1" title="1. 設定" :done="step_run > 1">
          ...
          <p class="text-red text-bold">
            「ポート開放不要化」ではご友人などがサーバーに入室するための設定を行いますのでお忘れなく！
          </p>
          <p>プロパティタグやプレイヤータグでも詳細な設定ができます！</p>
          <q-img
            src="~assets/Introduction/MainWindow.png"
            width="min(900px,100%)"
          />
          <q-stepper-navigation>
        ...
        <q-step :name="2" title="2. 起動" :done="step_run > 2">
          ...
          <p>※ 初回起動時は起動前にEula（利用規約）への同意を求められます</p>
          <q-img
            src="~assets/Introduction/Server2.png"
            width="min(700px,100%)"
          />
          <q-stepper-navigation>
            <q-btn
      ...
      <q-stepper v-model="step_participant" flat animated>
        <q-step
          :name="1"
          title="1. Minecraftの起動"
          :done="step_participant > 1"
        >
          <p>
            Minecraft
            Launcherを起動し，サーバーを起動したバージョンでゲームを開始してください
          </p>
          <p>
            バージョンがない時には「起動構成」から起動したいバージョンの追加が必要です！
          </p>
          <q-img
            src="~assets/Introduction/Launcher.png"
            width="min(500px,100%)"
          />
          <q-stepper-navigation>
            <q-btn
              @click="step_participant = 2"
              color="secondary"
              label="next"
            />
          </q-stepper-navigation>
        ...
        >
          ...
          <p>「完了」を押して作成されたサーバーに入れば準備完了です！</p>
          <q-img
            src="~assets/Introduction/client.png"
            width="min(500px,100%)"
          />
          <q-stepper-navigation>
            <q-btn
              @click="step_participant = 3"
              color="secondary"
              label="next"
            />
            <q-btn
              flat
              @click="step_participant = 1"
              color="secondary"
              label="Back"
              class="q-ml-sm"
            />
        ...
        <q-step
          :name="3"
          title="3. ご友人などがサーバーに参加する"
          :done="step_participant > 3"
        >
          <p>
            ご友人などがサーバーに参加する際には、
          ...
          <div class="row q-gutter-md">
            <q-img
              src="~assets/Introduction/ip.png"
              style="min-width: 15rem"
              class="col"
            />
            <q-img
              src="~assets/Introduction/client2.png"
              style="min-width: 15rem"
              class="col"
            />
          </div>
