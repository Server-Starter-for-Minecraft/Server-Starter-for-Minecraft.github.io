...
export const acacia_slab: ModelFaces = [
  {
    texture: '/assets/McModel/minecraft/textures/block/acacia_planks.00gg.webp',
    matrix3d: [
  ...
  {
    texture: '/assets/McModel/minecraft/textures/block/acacia_planks.08gg.webp',
    matrix3d: [
